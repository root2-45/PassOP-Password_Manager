...
//       </div>
//       <div className=" p-3 md:mycontainer min-h-[84.4vh]">
...
const Manager = () => {
  ...
  return (
    <>
      <ToastContainer
        position="top-right"
        autoClose={5000}  // Fixed typo: autoCloss -> autoClose
        hideProgressBar={false}
        closeOnClick
        rtl={false}
        pauseOnFocusLoss
      ...
      <div className="p-3 md:mycontainer min-h-[84.4vh]">
        ...
        <p className="text-pink-900 text-lg text-center">
          Your own Password Manager
        </p>
         </div> 
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          <input
            value={form.site}  // Fixed: FormData -> form
            onChange={handleChange}
            placeholder="Enter website URL"
            className="rounded-full border border-pink-500 w-full p-4 py-1"
            type="text"
            name="site"
            id="site"
          />
          ...
          <button
            onClick={savePassword}
            className="flex justify-center items-center gap-2 bg-pink-400 hover:bg-pink-300 rounded-full
        px-8 py-2 w-fit border border-pink-900"
          >
            <lord-icon
              src="https://cdn.lordicon.com/jgnvfzqg.json"
              trigger="hover"
                ...
                {passwordArray.map((item, index) => {
                  return (
                    <tr key={index}>
                      <td className="py-2 border border-white text-center">
                        <div className="flex items-center justify-center">
                          <a href={item.site} target="_blank" rel="noopener noreferrer">  {/* Added rel for security */}
                            {item.site}
                          </a>
                          <div
                            className="lordiconcopy size-7 cursor-pointer"
