...
//   {/* Your existing background div goes here */}
//   <div className="flex-grow p-3 md:mycontainer">
//     <h1 className="text-4xl text font-bold text-center">
//           <span className="text-green-500">&lt;</span>
//           <span>Pass</span>
//           <span className="text-green-500">OP/&gt;</span>
...
const Manager = () => {
  ...
  {/* Your existing background div goes here */}
  <div className=" p-2 md:mycontainer min-h-[1vh]">
    <h1 className="text-4xl text font-bold text-center">
        ...
        <div className="flex flex-col p-4 text-black gap-8 items-center">
          ...
          <button
            onClick={savePassword}
            className="flex justify-center items-center gap-2 bg-pink-400 hover:bg-pink-300 rounded-full px-8 py-2 w-fit border border-pink-900"
          >
            <lord-icon
              src="https://cdn.lordicon.com/jgnvfzqg.json"
              trigger="hover"
